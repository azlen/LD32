...
(function() {
  ...
  HowlerGlobal.prototype.orientation = function(x, y, z, xUp, yUp, zUp) {
    ...
    if (typeof x === 'number') {
      ...
      self.ctx.listener.setOrientation(self._orientation[0], self._orientation[1], self._orientation[2], self._orientation[3], self._orientation[4], self._orientation[5]);
    } else {
      return or;
    }
